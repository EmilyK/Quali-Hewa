...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analyser.identifier'
        db.add_column(u'hewa_analyser', 'identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=140, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Analyser.identifier'
        db.delete_column(u'hewa_analyser', 'identifier')
    ...
    models = {
        u'hewa.airqualityreading': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 25, 0, 0)', 'auto_now': 'True', 'null': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'hewa.analyser': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'max_length': '140', 'unique': 'True', 'null': 'True'}),
            ...
            'readings': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['hewa.AirQualityReading']", 'symmetrical': 'False', 'blank': 'True'}),
            'registered_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'})
        },
        u'hewa.station': {
